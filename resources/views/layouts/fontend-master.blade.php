...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="https://seeklogo.com/images/E/e-commerce-logo-B0AE7EE720-seeklogo.com.png" alt="" style="width: 100px;" alt=""></a>
        </div>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> davi@hotmail.com</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
