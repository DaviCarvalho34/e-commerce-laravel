...
<section class="breadcrumb-section set-bg" data-setbg="https://images.unsplash.com/photo-1600443546015-f9b924a5b416?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE0fHx8ZW58MHx8fHw%3D&w=1000&q=80">
    <div class="container">
        <div class="row">
                            ...
                            @foreach ($carts as $cart)
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="{{ asset($cart->product->image_one) }}" style="width:70px;height:70px;" alt="">
                ...
                <div class="shoping__continue">
                    <div class="shoping__discount">
                        ...
                        <form action="{{ url('coupon/destroy') }}" method="POST">
                            @csrf
                            <button type="submit" class="site-btn">REMOVE COUPON</button>
                        </form>
                    </div>
                </div>
                @else
