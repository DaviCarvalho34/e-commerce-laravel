                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <div class="hero__item">
                        <div class="hero__text">
                            ...
                            <h2>Promotion <br />30% Discount</h2>
                            <p>Free Pickup and Delivery Available</p>
                            <a href="#" id="hero-btn" class="primary-btn">SHOP NOW</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="latest-product__text">
                    ...
                    <div class="latest-product__slider owl-carousel">
                        ...
                        <div class="latest-prdouct__slider__item">
                            @php
                                $top_products = App\Models\Product::where('status',1)->latest()->limit(3)->get();
                            @endphp
            ...
            <div class="col-lg-4 col-md-6">
                <div class="latest-product__text">
                    ...
                    <div class="latest-product__slider owl-carousel">
                        <div class="latest-prdouct__slider__item">
                            @php
                                $products = App\Models\Product::where('status',1)->latest()->limit(3)->get();
                            @endphp
                            @foreach ($products as $product)
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
